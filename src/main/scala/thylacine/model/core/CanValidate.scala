...
/** We use the type system to ensure the right structure of the Bayesian Graph components. but do not use it in
  * validating the mathematics of the underpinning computations. Doing so would make the typing model significantly more
  * complicated to get some relative simple sanity checks in place.
  *
